...
#define _E4E1_TAU_TDR00_VALUE                   (0xE4E1U)
/* Clock divisor for TAU0 channel 0 */
#define _8000_TAU0_CHANNEL0_DIVISOR             (0x8000U)
/* 16-bit timer data register 01 (TDR01) */
#define _61A7_TAU_TDR01_VALUE                   (0x61A7U)
/* Clock divisor for TAU0 channel 1 */
#define _0080_TAU0_CHANNEL1_DIVISOR             (0x0080U)
